...
import 'package:social_media_test/core/helper/extensions/material_color_converter.dart';
...
class ImagesKeys {
  ...
  static String get splashLogo => "lib/assets/images/png/splashscreen.png";
  ...
  static String get userImage=>"lib/assets/images/png/user.png";
  ...
  static String get userIcon => "lib/assets/images/png/user.png";
  static String get dropPin => "lib/assets/images/png/drop_pin.png";
  static String get listIcon => "lib/assets/images/png/list.png";
  static String get lock => "lib/assets/images/png/padlock.png";
  static String get shoppingBag => "lib/assets/images/png/shopping_bag.png";
  static String get settings => "lib/assets/images/png/setting.png";
  static String get heartIcon => "lib/assets/images/png/heart.png";
}
...
class AppTheme {
  ...
  static TextTheme appTextTheme(Color color) => TextTheme(
        displayLarge: TextStyle(fontSize: 57.sp, fontWeight: FontWeight.w400, color: color),
        displayMedium: TextStyle(fontSize: 45.sp, fontWeight: FontWeight.w400, color: color),
        displaySmall: TextStyle(fontSize: 36.sp, fontWeight: FontWeight.w400, color: color),
        ...
        headlineSmall: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w400, color: color),
        ...
        titleLarge: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w400, color: color),
